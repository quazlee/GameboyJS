            ...
            case 0x0:
                switch (low) {
                    case 0x0:
                        ...
                        break;
                    case 0x1:
                        this.registers.setRegister(0, 1, this.fetch(), this.fetch());
                        this.tickClock(12);
                        break;
                    case 0x2:
                        this.memory.writeMemory(this.registers.getRegisterDouble(0, 1), this.registers.getRegister(6))
                        this.tickClock(8);
                        break;
                    case 0x3:
                        this.registers.incRegisterDouble(0, 1);
                        this.tickClock(8);
                        break;
                    case 0x4:
                        this.registers.incRegister(0);
                        this.tickClock(4);
                        break;
                    case 0x5:
                        this.registers.decRegister(0);
                        this.tickClock(4);
                        break;
                    case 0x6:
                        this.registers.setRegister(0, this.fetch());
                        this.tickClock(4);
                        break;
                    case 0x7:
                        ...
                        break;
                    case 0x8:
                        this.memory.writeMemory((this.fetch() << 8) | this.fetch(), this.stackPointer);
                        this.tickClock(20);
                        break;
                    case 0x9:
